...
import { MouseoverClipboardService } from './mouseover-clipboard.service';

let httpTestingController: HttpTestingController;
let service: MouseoverClipboardService;

describe('Mouseover Clipboard service', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule],
      providers: [MouseoverClipboardService],
    });
    const httpClient = TestBed.inject(HttpClient);
    httpTestingController = TestBed.inject(HttpTestingController);
    service = TestBed.inject(MouseoverClipboardService)
  });
